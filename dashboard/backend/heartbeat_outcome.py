...
def verdict_via_nvidia(work_report, conn) -> dict | None:
    ...
    prompt = (
        "Você é o painel de revisão da EvoNexus, operando com DOIS revisores "
        "mesclados num só veredito: (1) o criticista de mérito (raven-critic — "
        "qualidade, clareza, se resolve a meta) e (2) o verificador de evidência "
        "(oath-verifier — a alegação de conclusão tem prova real ou é só afirmação). "
        "Avalie o relatório de trabalho abaixo e decida se está pronto para ser "
        "considerado concluído (pass) ou precisa de correção (fail).\n\n"
        f"Relatório do agente:\n{report[:4000]}\n\n"
        "Regras:\n"
        "- Lente de mérito: reprove (fail) se o resultado é genérico, não atende a "
        "meta, tem furo de qualidade ou ficou superficial.\n"
        "- Lente de evidência: reprove (fail) se falta evidência concreta (build/"
        "teste passou, número com origem, artefato criado) e o relatório apenas "
        "ALEGA que concluiu.\n"
        "- verdict='pass' somente se as DUAS lentes passam: trabalho concreto, de boa "
        "qualidade, e com evidência/resultado verificável.\n"
        ...
        "- critique: 1-3 frases em pt-BR explicando a decisão (cite qual lente "
        "falhou, se fail).\n"
